...
\begin{entrylist}
  \entry
    ...
    {Working as Researcher in the Big Data analytics group in Eurecat. Working in multiple projects providing consulting and development support for big data tools. Mostly working in Elastic search, Spark, MongoDB, Hive and Pig. Also managing the in house private cloud infrastructure using Red Hat Openstack Cloud Platform. \\}
		\iffalse
\entry
    {Aug. 14 - Jun. 18}
